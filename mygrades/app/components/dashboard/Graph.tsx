...
const Graph = () => {
  ...
  return (
    <div className='col-span-8 overflow-hidden rounded border border-stone-300 shadow'>
        <div className='p-4'>
             <span className='flex items-center gap-1.5 font-medium'><HiBeaker /> Mathématique et Physique</span>
        </div>  
        ...
        <ResponsiveContainer width="100%" height="100%">
            <LineChart width={300} height={100} data={data} margin={{top:0, right:5, left:-42, bottom:0}}>
                ...
                <YAxis axisLine={false} className='text-xs font-bold' tickLine={false} domain={[0, 6]}/>
